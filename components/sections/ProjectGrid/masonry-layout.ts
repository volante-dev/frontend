export type MasonrySize = "NORMAL" | "HERO";

export type MasonryLayoutItem = {
  id: string;
  portfolioSize: MasonrySize;
};
...
/**
 * Desktop uses the mobile/editor order as its source of truth. Heroes alternate
 * left/right and the following normal projects fill the opposite 2 x 2 block.
 */
